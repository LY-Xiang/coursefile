...
VkResult CreateGraphicsPipeline(void) {
  ...
  loadShaderFromFile("resources/tri.vert.spv", &vertexShader, VERTEX_SHADER);
  loadShaderFromFile("resources/tri.frag.spv", &fragmentShader, FRAGMENT_SHADER);
