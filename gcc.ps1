...
C:/msys64/usr/bin/bash.exe -lc 'pacman --noconfirm -Syyuu' # 全面更新
C:/msys64/usr/bin/bash.exe -lc 'pacman --noconfirm -Syuu {mingw-w64-ucrt-x86_64-toolchain,zsh}' # 更新并安装所需资源
